...
class MahasiswaPklController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('mahasiswapkl.index', compact('mahasiswa_pkl'));
    }
...
//     return view('mahasiswapkl.penilaian', compact('mahasiswaPkl'));
// }
...
// }
    ...
    //     return view('mahasiswapkl.pembimbing', compact('mahasiswaPkl', 'dosen'));
    // }
    ...
    //         'id_mhs_pkl' => 'required|exists:mahasiswa_pkl,id_mhs_pkl', // Validasi ID mahasiswa PKL
    //     ]);

    //     // Pastikan data mahasiswa PKL ditemukan
    //     $mahasiswaPkl = MahasiswaPKL::findOrFail($request->id_mhs_pkl);
    ...
    public function jadwal($id)
    {
        ...
        // Kirim data ke view
        return view('mahasiswapkl.jadwal', compact('dosen', 'mahasiswaPkl','sesi'));
    }
    ...
    public function jadwalSidang()
    {
        ...
        $sesi = Sesi::all();
        $dosen = Dosen::all();
        return view('mahasiswapkl.jadwal', compact('dosen','sesi'));
    }
    ...
    public function storeJadwal(Request $request)
    {
        ...
        // Validasi input
        $request->validate([
            'id_mhs_pkl' => 'required|exists:mahasiswa_pkl,id_mhs_pkl',
        ...
        $mahasiswaPkl = MahasiswaPkl::find($request->id_mhs_pkl);
    ...
    public function create()
    {
        ...
        return view('mahasiswapkl.create', compact('dosen', 'jadwal_sidang', 'prodi', 'jurusan', 'mahasiswa', 'sesi','registrasi_pkl'));
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('mahasiswa_pkl.index')
    ...
    public function edit(MahasiswaPkl $mahasiswaPkl)
    {
        $mahasiswa = Mahasiswa::all();
        $tempat_pkl = TempatPkl::all();
        return view('mahasiswapkl.edit', compact('mahasiswaPkl', 'mahasiswa', 'tempat_pkl'));
    }
     ...
     public function show($id)
{
    ...
    return view('mahasiswapkl.show', compact('mahasiswaPkl', 'dosen_pembimbing', 'dosen_penguji'));
}

    public function update(Request $request, MahasiswaPkl $mahasiswaPkl)
    {
        $request->validate([
            'id_mhs' => 'nullable|exists:mahasiswa,id_mhs',
            'judul' => 'required|string|max:255',
            'ruangan_sidang' => 'required|string|max:255',
            'id_tempat_pkl' => 'nullable|exists:tempat_pkl,id_tempat_pkl',
