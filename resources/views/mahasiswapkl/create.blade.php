...
<div class="container-fluid">
    <div class="card shadow mb-4">
        ...
        <div class="card-body">
            <form action="{{ route('mahasiswa_pkl.store') }}" method="POST" enctype="multipart/form-data">
                @csrf
                <!-- Informasi Utama -->
                <div class="card mb-4">
                    ...
                    <div class="mb-3">
                        <label for="id_mhs">Mahasiswa <span class="text-danger">*</span></label>
                        <select class="form-control @error('id_mhs') is-invalid @enderror" id="id_mhs" name="id_mhs" required>
